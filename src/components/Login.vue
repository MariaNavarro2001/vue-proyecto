<template>
  <div class="min-h-screen flex items-center justify-center bg-gray-100">
    <div class="bg-white p-8 rounded shadow-md w-full max-w-sm">
      ...
      <img 
        src="https://th.bing.com/th/id/OIP.XRyWS8gmaKVzwwPZUxud-AHaHa?rs=1&pid=ImgDetMain" 
...
<style scoped>
.min-h-screen {
  height: 100vh; /* Asegúrate de que la altura mínima cubra toda la pantalla */
}

.bg-white {
  width: 100%; /* Permite que el fondo blanco ocupe todo el ancho */
}
